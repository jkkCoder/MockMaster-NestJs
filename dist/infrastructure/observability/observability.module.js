...
exports.ObservabilityModule = ObservabilityModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [logger_service_1.AppLoggerService, metrics_service_1.MetricsService, jwt_service_1.JwtService],
        exports: [logger_service_1.AppLoggerService, metrics_service_1.MetricsService, jwt_service_1.JwtService],
    })
], ObservabilityModule);
