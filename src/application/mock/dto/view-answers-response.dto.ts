...
export class OptionWithAnswerResponseDto {
...
export class QuestionWithAnswerResponseDto {
  ...
  @ApiProperty({ description: 'Options for this question with correct answer marked', type: [OptionWithAnswerResponseDto] })
  options: OptionWithAnswerResponseDto[];
}

export class SectionWithAnswersDto {
  ...
  @ApiProperty({ description: 'Questions in this section with answers', type: [QuestionWithAnswerResponseDto] })
  questions: QuestionWithAnswerResponseDto[];
}

export class ViewAnswersResponseDto {
  ...
  @ApiProperty({ description: 'Sections with questions and options (with correct answers marked)', type: [SectionWithAnswersDto] })
  sections: SectionWithAnswersDto[];
}
